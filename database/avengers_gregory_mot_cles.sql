...
LOCK TABLES `mot_cles` WRITE;
/*!40000 ALTER TABLE `mot_cles` DISABLE KEYS */;
INSERT INTO `mot_cles` VALUES (1,'Google'),(2,'Rouge'),(3,'Bleu'),(4,'Jaune');
/*!40000 ALTER TABLE `mot_cles` ENABLE KEYS */;
UNLOCK TABLES;
